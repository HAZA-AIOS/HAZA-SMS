...
export default function AccessControlPanel({data}: {data:AccessData}){
  ...
  return <div className={cn("access-page",moduleSurface)}>
    ...
    <section className="mb-4 rounded-2xl border border-violet-400/20 bg-violet-500/10 p-4 text-sm leading-6 text-violet-100"><strong className="block text-white">Email-based accounts</strong>Invite the user with their exact email address and assign a role. They sign in through the public Sign in page; HAZA-SMS does not create, display or store separate dashboard passwords.</section>
