...
export const moduleSurface = "module-surface min-w-0 space-y-5 text-sm text-slate-700 [&_h1]:text-[28px] [&_h1]:font-black [&_h1]:tracking-tight [&_h1]:text-slate-950 [&_h2]:font-extrabold [&_h2]:text-slate-950 [&_h3]:font-bold [&_h3]:text-slate-900 [&_label]:text-[13px] [&_label]:font-semibold [&_input:not([type=checkbox]):not([type=radio])]:min-h-10 [&_input:not([type=checkbox]):not([type=radio])]:rounded-lg [&_input:not([type=checkbox]):not([type=radio])]:border [&_input:not([type=checkbox]):not([type=radio])]:border-slate-300 [&_input:not([type=checkbox]):not([type=radio])]:bg-white [&_input:not([type=checkbox]):not([type=radio])]:px-3 [&_input:not([type=checkbox]):not([type=radio])]:text-[13px] [&_select]:min-h-10 [&_select]:rounded-lg [&_select]:border [&_select]:border-slate-300 [&_select]:bg-white [&_select]:px-3 [&_select]:text-[13px] [&_textarea]:min-h-24 [&_textarea]:rounded-lg [&_textarea]:border [&_textarea]:border-slate-300 [&_textarea]:bg-white [&_textarea]:px-3 [&_textarea]:py-2 [&_textarea]:text-[13px] [&_button]:min-h-9 [&_button]:rounded-lg [&_button]:px-3 [&_button]:py-1.5 [&_button]:text-[13px] [&_button]:font-semibold [&_button]:transition focus-within:[&_input]:border-red-500 focus-within:[&_select]:border-red-500";
